...
*Additional Notes:* ${formData.message || "None"}`;
  ...
  const categories = [
    { 
      ...
      Icon: Trees,
      downloads: [
        { label: "Brochure 1", url: "/farm land/1.pdf" },
        { label: "Brochure 2", url: "/farm land/2.pdf" },
        { label: "Brochure 3", url: "/farm land/3.pdf" }
      ]
    },
    { 
      ...
      Icon: Landmark,
      downloads: [
        { label: "Brochure 1", url: "/commercial land/1.pdf" },
        { label: "Brochure 2", url: "/commercial land/2.pdf" },
        { label: "Brochure 3", url: "/commercial land/3.pdf" },
        { label: "Brochure 4", url: "/commercial land/4.pdf" }
      ]
    },
    { 
      title: "Open Plots", 
    ...
    { 
      ...
      Icon: Home,
      downloads: [
        { label: "Brochure 1", url: "/villa development/1.pdf" },
        { label: "Brochure 2", url: "/villa development/2.pdf" }
      ]
    },
    { 
      ...
      Icon: Building,
      downloads: [
        { label: "Brochure 1", url: "/apartment development/1.pdf" },
        { label: "Brochure 2", url: "/apartment development/2.pdf" }
      ]
    },
    { 
      title: "Resale Flats", 
