...
export const ServiceCard = ({ title, description, Icon, href }: ServiceCardProps) => {
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="glass-card group flex flex-col h-full bg-white border border-slate-100 transition-all duration-700 hover:-translate-y-4 hover:shadow-[0_40px_100px_rgba(15,23,42,0.12)] !p-0 overflow-hidden"
    >
      ...
      <div className="p-10 flex flex-col flex-grow">
        ...
        <Link href={href} className="inline-flex items-center gap-4 text-[11px] font-black text-slate-400 group-hover:text-black group-hover:gap-6 transition-all uppercase tracking-[0.5em] group/link">
          Explore Strategy 
