          ...
          <div className="max-w-[1000px] mx-auto">
            ...
            >
              ...
              >
                ...
                <div className="space-y-3">
                  <label className="text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 flex items-center gap-3">
                    <PhoneIcon size={14} className="text-amber-600" /> Mobile
                    Number
                  </label>
                  <input
                    type="tel"
                ...
                <div className="md:col-span-2 space-y-3">
                  <label className="text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 flex items-center gap-3">
                    <MapPinIcon size={14} className="text-amber-600" /> Location
                    of Property
                  </label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2 space-y-3">
                  <label className="text-[11px] font-black uppercase tracking-[0.3em] text-stone-400 flex items-center gap-3">
                    <MessageSquare size={14} className="text-amber-600" /> Write
                    us if any
                  </label>
                  <textarea
                    name="message"
