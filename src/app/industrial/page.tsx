...
const projectData = [
  {
    ...
    description:
      "Operational pharmaceutical unit with 15+ years of market presence. Specializes in API manufacturing with WHO-GMP certification.",
    pdfUrl: "/brochures/industrial-1.pptx",
  },
  {
    id: "project2",
    title: "Project 2 – Active Pharmaceutical Company",
    description:
      "Large-scale liquid injection and tablet production facility. Features state-of-the-art HVAC systems and automated packaging units.",
    pdfUrl: "/brochures/industrial-2.pptx",
  },
  {
    id: "project3",
    title: "Project 3 – Pharmaceutical Formulation Company",
    description:
      "Focused on generic drug formulations with strong portfolio of patented delivery mechanisms and high scalability potential.",
    pdfUrl: "/brochures/industrial-3.pptx",
  },
];
  ...
  const faqs = [
    {
      ...
      answer:
        "We primarily focus on pharmaceutical manufacturing units, formulation companies, and active pharmaceutical ingredient (API) facilities. We also handle large-scale manufacturing infrastructure projects.",
    },
    {
      question: "How does the non-collateral funding work?",
      answer:
        "Our funding solutions up to ₹500 Crores are based on project viability, company financials, and strategic growth potential. Terms and conditions apply based on the specific industry and scale of operation.",
    },
  ];
        ...
        <div className="section-container relative z-10 text-center">
          ...
          >
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <span className="text-[10px] uppercase tracking-[0.5em] font-black text-emerald-500">
                Industrial Scale-Up
              </span>
              <div className="w-12 h-[1px] bg-emerald-500" />
            </div>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-10 leading-[1] tracking-[-0.03em] text-white uppercase drop-shadow-2xl">
              Connecting{" "}
              <span className="font-serif italic capitalize font-light text-slate-300 tracking-normal">
                Global
              </span>{" "}
              <br />
            ...
            <p className="text-xl md:text-2xl text-slate-400 max-w-[800px] mx-auto font-medium leading-relaxed tracking-tight">
              Connecting investors and enterprises with high-value industrial
              projects, specializing in pharmaceutical and strategic
      ...
      <section className="section-container -mt-16 relative z-20 pb-16">
        ...
        <div className="mb-12 pt-10">
          <h2 className="text-3xl md:text-6xl font-black mb-12 tracking-tighter text-slate-950 leading-tight">
            ...
            <span className="serif-emphasis text-slate-400">Assets</span>
          </h2>
              ...
              >
                <div className="relative w-full lg:w-[550px] aspect-[16/10] overflow-hidden rounded-[3rem] bg-slate-100">
                  <Image
                    ...
                    alt={project.title}
                    fill
                    className="object-cover opacity-95 group-hover:scale-110 transition-transform duration-1000"
                  />
                  <div className="absolute inset-0 bg-emerald-950/10 group-hover:bg-transparent transition-colors duration-700" />
                </div>
                <div className="flex-grow">
                  <span className="text-[10px] uppercase tracking-[0.4em] font-black text-emerald-600 mb-6 block">
                    Project Insight
                  </span>
                  <h3 className="text-3xl md:text-5xl font-black mb-8 text-slate-900 tracking-tight leading-tight group-hover:text-emerald-700 transition-colors">
                    {project.title}
                  </h3>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-12 mb-20">
            <div className="bg-white p-12 rounded-[4rem] shadow-[0_20px_80px_rgba(0,0,0,0.02)] group hover:-translate-y-4 transition-all duration-700 border border-slate-50">
              ...
              <h3 className="text-3xl md:text-4xl font-black mb-6 text-slate-900 tracking-tight group-hover:text-emerald-700 transition-colors">
                Private Funding
              </h3>
              <p className="text-slate-600 mb-8 text-lg md:text-xl font-medium leading-relaxed">
                We provide structured financial support to industries with
                funding solutions up to{" "}
                <span className="text-emerald-600 font-black">₹500 Crores</span>
                , designed to accelerate business growth.
              </p>
              <p className="text-emerald-600/50 text-[10px] mb-10 font-black uppercase tracking-[0.3em] italic">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div
                    key={item}
                    className="flex gap-5 items-center text-slate-700 font-bold"
                  >
            ...
            <div className="bg-slate-900 p-12 rounded-[4rem] shadow-[0_20px_80px_rgba(0,0,0,0.05)] group hover:-translate-y-4 transition-all duration-700 text-white">
              ...
              <h3 className="text-3xl md:text-4xl font-black mb-6 text-white tracking-tight group-hover:text-emerald-400 transition-colors">
                Equity Funding
              </h3>
              <p className="text-slate-400 mb-10 text-lg md:text-xl font-medium leading-relaxed">
                We facilitate equity-based funding solutions by connecting
                businesses with strategic investors and long-term capital
                support.
              </p>
              <div className="space-y-6">
                {[
                  ...
                  "Focus on scalable industries",
                ].map((item) => (
                  <div
                    key={item}
                    className="flex gap-5 items-center text-slate-300 font-bold"
                  >
            ...
            <div className="bg-white p-12 rounded-[4rem] shadow-[0_20px_80px_rgba(0,0,0,0.02)] group hover:-translate-y-4 transition-all duration-700 border border-slate-50 mt-12 xl:mt-0">
              <div className="w-20 h-20 rounded-[2rem] bg-slate-100 text-slate-900 flex items-center justify-center mb-10 group-hover:bg-slate-900 group-hover:text-white transition-all duration-700 shadow-sm group-hover:shadow-2xl">
                <MapPinIcon size={40} strokeWidth={2.2} />
              </div>
              <h3 className="text-3xl md:text-4xl font-black mb-6 text-slate-900 tracking-tight group-hover:text-slate-700 transition-colors">
                Industrial Lands
              </h3>
              <p className="text-slate-600 mb-8 text-lg md:text-xl font-medium leading-relaxed">
                We help identify and structure industrial land opportunities for
                manufacturing, warehousing, and logistics projects across
                strategic growth corridors.
              </p>
              <div className="space-y-6">
                {[
                  "Location-ready site selection",
                  "Clear title and due diligence support",
                  "Development-focused land advisory",
                ].map((item) => (
                  <div
                    key={item}
                    className="flex gap-5 items-center text-slate-700 font-bold"
        ...
        <div className="mb-12 pt-12 border-t border-slate-200">
          <div className="max-w-[1000px] mx-auto">
            ...
            >
              <span className="subheading mx-auto !text-emerald-600">
                Strategic Inquiry
              </span>
              <h2 className="text-4xl md:text-6xl font-black text-slate-950 tracking-tighter mb-6">
                Share Your{" "}
                <span className="font-serif italic font-light text-slate-400">
                  Requirements
                </span>
              ...
              <p className="text-slate-600 text-xl md:text-2xl font-medium max-w-2xl mx-auto">
                Connecting visions with execution. Share your requirements and
                our experts will craft a solution.
              </p>
            </motion.div>
            ...
            >
              ...
              >
                ...
                <div className="space-y-3">
                  <label className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400 flex items-center gap-3">
                    <PhoneIcon size={14} className="text-emerald-600" /> Mobile
                    Number
                  </label>
                  <input
                    type="tel"
                ...
                <div className="space-y-3">
                  <label className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400 flex items-center gap-3">
                    <IndianRupee size={14} className="text-emerald-600" /> Cost
                    of Industry
                  </label>
                  <input
                    type="text"
        ...
        >
          <div className="mb-12 text-center">
            <span className="subheading !text-emerald-600 mx-auto">
              Direct Answers
            </span>
            <h2 className="text-3xl md:text-7xl font-black text-slate-950 tracking-tighter mb-6">
              Frequently Asked{" "}
              <span className="serif-emphasis text-slate-400">Questions</span>
            </h2>
          </div>
            ...
            {faqs.map((faq, idx) => (
              ...
              >
                ...
                >
                  {faq.question}
                  <div
                    className={`w-10 h-10 md:w-14 md:h-14 rounded-xl md:rounded-2xl border border-slate-100 flex items-center justify-center group-hover:border-emerald-500 transition-all ${openFaq === idx ? "rotate-180 bg-emerald-600 border-emerald-600 text-white" : ""}`}
                  >
                    <ChevronDown
                      size={20}
